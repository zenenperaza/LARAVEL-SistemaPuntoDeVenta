...
<div class="content col-6"> 
    <div class="card card-primary" >
        <div class="card-header">
            <h3 class="card-header">Editar Proveedor</h3>
        </div>
      <div class="card-body">
        <br>
        ...
        <form action="{{ route('proveedor.update', $proveedor->id_persona) }}" method="POST" class="form">
          ...
          <div class="mb-3">
              ...
              <select class="form-control" id="tipo_documento" name="tipo_documento"> 
                <option  value="{{ $proveedor->tipo_documento }}">{{ $proveedor->tipo_documento }}</option>            
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="num_documento"  name="num_documento"  value="{{ $proveedor->num_documento }}"  >           
          </div>
